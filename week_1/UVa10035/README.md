...
Eliminated vector arrays. Used variables (like bool carry) to track whether is carry or not, achieving zero extra space overhead.<br>
...
<ruby>allocations<rt>*分配*</rt></ruby> (push_back) and processes everything in a single loop.<br>
